        ...
        <form>
          <fieldset>
            ...
            <ul>
              <li class="li-span-2">
                <label>本分控状态</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.State">
              </li>
              <li class="li-span-2">
                <label>自检状态</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.examination_state">
              </li>
              <li class="li-span-2">
                <label>OUT1_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT1_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT2_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT2_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT3_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT3_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT4_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT4_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT5_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT5_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT6_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT6_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT7_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT7_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT8_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT8_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT9_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT9_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT10_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT10_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT11_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT11_SEL">
              </li>
              <li class="li-span-2">
                <label>OUT12_SEL</label>
                <input type="text" disabled v-model="Status.StationInter_state_report.OUT12_SEL">
              </li>
            </ul>
          </fieldset>
        </form>
