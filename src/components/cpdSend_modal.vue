    ...
    <form>
      <fieldset>
        ...
        <ul>
          <li class="li-span-1">
            <label>控制模式</label>
            <el-radio-group v-model="Setting.StationSendZero_parameter_setting.State">
          ...
          <li class="li-span-1">
            ...
            <el-radio-group v-model="Setting .StationSendZero_parameter_setting.onLine">
          ...
          <li class="li-span-1">
            <label>群时延本振测试</label>
            <el-radio-group v-model="Setting .StationSendZero_parameter_setting.loTest">
          ...
          <li class="li-span-1">
            <label>射频输入选择</label>
            <el-radio-group v-model="Setting.StationSendZero_parameter_setting.input">
              <el-radio label="C发射无线校零校验">C发射无线校零校验</el-radio><br>
              <el-radio label="C发射有线校零校验">C发射有线校零校验</el-radio>
            </el-radio-group>
          </li>
          <li class="li-span-1">
            <label>中频输出选择</label>
            <el-radio-group v-model="Setting.StationSendZero_parameter_setting.output">
              <el-radio label="有源通道">有源通道</el-radio>
              <el-radio label="无源通道">无源通道</el-radio>
            </el-radio-group>
          </li>
        </ul>
      </fieldset>
