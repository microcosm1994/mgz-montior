        ...
        <ul>
          ...
          <li class="li-span-4">
            ...
            <el-select v-model="Setting.KA_S_recv_param.PllBw" size="mini">
              <el-option label="5HZ" value="5HZ"></el-option>
              <el-option label="10HZ" value="10HZ"></el-option>
              <el-option label="100HZ" value="100HZ"></el-option>
              <el-option label="500HZ" value="500HZ"></el-option>
              <el-option label="1kHZ" value="1kHZ"></el-option>
            </el-select>
          </li>
          <li class="li-span-4">
            <label>接收伪码类型</label>
