    ...
    <form>
      <fieldset>
        ...
        <ul>
          <li class="li-span-1">
            <label>衰减[0~55]</label>
            <input type="text" v-model="Setting.StationDown_parameter_setting.attenuation">
          </li>
          <li class="li-span-1">
            <label>控制模式</label>
            <el-radio-group v-model="Setting .StationDown_parameter_setting.State">
          ...
          <li class="li-span-1">
            ...
            <el-radio-group v-model="Setting .StationDown_parameter_setting.onLine">
          ...
          <li class="li-span-1">
            <label>群时延本振测试</label>
            <el-radio-group v-model="Setting .StationDown_parameter_setting.loTest">
          ...
          <li class="li-span-1">
            ...
            <el-radio-group v-model="Setting.StationDown_parameter_setting._28V1_output">
              <el-radio label="开启">开启</el-radio>
              <el-radio label="关断">关断</el-radio>
            </el-radio-group>
          </li>
          <li class="li-span-1">
            <label>28V2输出开启/关断</label>
            <el-radio-group v-model="Setting.StationDown_parameter_setting._28V2_output">
              <el-radio label="开启">开启</el-radio>
              <el-radio label="关断">关断</el-radio>
            </el-radio-group>
          </li>
          <li class="li-span-1">
            ...
            <el-radio-group v-model="Setting.StationDown_parameter_setting._9V1_output">
              <el-radio label="开启">开启</el-radio>
              <el-radio label="关断">关断</el-radio>
            </el-radio-group>
          </li>
          <li class="li-span-1">
            ...
            <el-radio-group v-model="Setting.StationDown_parameter_setting._9V2_output">
              <el-radio label="开启">开启</el-radio>
              <el-radio label="关断">关断</el-radio>
            </el-radio-group>
          </li>
          <li class="li-span-1">
            <label>控制切换开关</label>
            <el-radio-group v-model="Setting.StationDown_parameter_setting.Control_switch">
              <el-radio label="LNA_A">LNA(A)</el-radio>
              <el-radio label="LNA_B">LNA(B)</el-radio>
            </el-radio-group>
          </li>
        </ul>
      </fieldset>
