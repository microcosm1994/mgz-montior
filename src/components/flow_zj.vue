    ...
    <form>
      <fieldset>
        ...
        <ul>
          <li class="li-span-1">
            <label>本分控状态</label>
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.State" placeholder="请选择">
              <el-option
                label="分控"
                value="分控">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT1_SEL" placeholder="请选择">
              <el-option
                label="输入1(卫通发射基带A)"
                value="输入1(卫通发射基带A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT2_SEL">
              <el-option
                label="输入1(卫通发射基带A)"
                value="输入1(卫通发射基带A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT3_SEL">
              <el-option
                label="输入3(C发校零中频出)"
                value="输入3(C发校零中频出)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT4_SEL">
              <el-option
                label="输入3(C发校零中频出)"
                value="输入3(C发校零中频出)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT5_SEL">
              <el-option
                label="输入1(卫通发射基带A)"
                value="输入1(卫通发射基带A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT6_SEL">
              <el-option
                label="输入1(卫通发射基带A)"
                value="输入1(卫通发射基带A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT7_SEL">
              <el-option
                label="输入7(C下变频器A)"
                value="输入7(C下变频器A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT8_SEL">
              <el-option
                label="输入8(C下变频器B)"
                value="输入8(C下变频器B)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT9_SEL">
              <el-option
                label="输入9(卫通接收基带A)"
                value="输入9(卫通接收基带A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT10_SEL">
              <el-option
                label="输入1(卫通发射基带A)"
                value="输入1(卫通发射基带A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT11_SEL">
              <el-option
                label="输入1(卫通发射基带A)"
                value="输入1(卫通发射基带A)">
              </el-option>
          ...
          <li class="li-span-1">
            ...
            <el-select size="mini" v-model="Setting.StationInter_parameter_setting.OUT12_SEL">
              <el-option
                label="输入1(卫通发射基带A)"
                value="输入1(卫通发射基带A)">
              </el-option>
