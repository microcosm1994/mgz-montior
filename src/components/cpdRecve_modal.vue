    ...
    <form>
      <fieldset>
        ...
        <ul>
          <li class="li-span-1">
            <label>控制模式</label>
            <el-radio-group v-model="Setting.StationRecvZero_parameter_setting.State">
          ...
          <li class="li-span-1">
            ...
            <el-radio-group v-model="Setting .StationRecvZero_parameter_setting.onLine">
          ...
          <li class="li-span-1">
            <label>群时延本振测试</label>
            <el-radio-group v-model="Setting .StationRecvZero_parameter_setting.loTest">
          ...
          <li class="li-span-1">
            <label>中频输出选择</label>
            <el-radio-group v-model="Setting.StationRecvZero_parameter_setting.output">
