    ...
    <form>
      <fieldset>
        ...
        <ul>
          <li class="li-span-1">
            <label>控制模式</label>
            <el-select size="mini" v-model="Setting.RecvZero_parameter_setting.State" placeholder="请选择">
          ...
          <li class="li-span-1">
            ...
            <el-radio-group v-model="Setting .RecvZero_parameter_setting.onLine">
          ...
          <li class="li-span-1">
            <label>群时延本振测试</label>
            <el-radio-group v-model="Setting .RecvZero_parameter_setting.loTest">
          ...
          <li class="li-span-1">
            <label>射频输出选择</label>
            <el-select size="mini" v-model="Setting.RecvZero_parameter_setting.Shoot" placeholder="请选择">
              <el-option label="无源通道" value="无源通道"></el-option>
              <el-option label="有源通道" value="有源通道"></el-option>
            </el-select>
          </li>
        </ul>
      </fieldset>
