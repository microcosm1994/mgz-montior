    ...
    <form>
      <fieldset>
        ...
        <div style="text-align: center">
          <li class="li-span-1">
            <label>切换方式控制使能</label>
            <el-select v-model="Setting.C_switch_command_frame.set_amplifier" slot="prepend" size="mini">
              <el-option label="不设置" value="不设置"></el-option>
              <el-option label="设置" value="设置"></el-option>
            </el-select>
          </li>
          <li class="li-span-1">
            <label>功放切换方式</label>
            <el-select v-model="Setting.C_switch_command_frame.work_mode" slot="prepend" size="mini">
              <el-option label="自动切换" value="自动切换"></el-option>
              <el-option label="手动切换" value="手动切换"></el-option>
            </el-select>
          </li>
          <li class="li-span-1">
            <label>功放输出开关控制使能</label>
            <el-select v-model="Setting.C_switch_command_frame.output_amplifier" slot="prepend" size="mini">
              <el-option label="不设置" value="不设置"></el-option>
              <el-option label="设置" value="设置"></el-option>
            </el-select>
          </li>
          <li class="li-span-1">
            <label>功放输出开关控制</label>
            <el-select v-model="Setting.C_switch_command_frame.output_control" slot="prepend" size="mini">
              <el-option label="切换到主功放输出" value="切换到主功放输出"></el-option>
              <el-option label="切换到备功放输出" value="切换到备功放输出"></el-option>
              <el-option label="维持上一状态" value="维持上一状态"></el-option>
            </el-select>
          </li>
        </div>
      </fieldset>
