    ...
    <form>
      <fieldset>
        ...
        <ul>
          <li class="li-span-1">
            <label>控制模式</label>
            <el-select size="mini" v-model="Setting.SGUP_up_parameter_setting.State" slot="prepend" placeholder="请选择">
          ...
          <li class="li-span-1">
            <label>衰减</label>
            <input type="text" v-model="Setting.SGUP_up_parameter_setting.attenuation">
          </li>
          <li class="li-span-1">
            <label>在线/不在线状态</label>
            <el-radio-group v-model="Setting .SGUP_up_parameter_setting.onLine">
          ...
          <li class="li-span-1">
            <label>群时延本振测试</label>
            <el-radio-group v-model="Setting .SGUP_up_parameter_setting.loTest">
